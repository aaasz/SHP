...
extern void test_function_two(co_stream s_in, co_stream s_out);
extern void function_two(co_stream s_in, co_stream s_out);
extern void stub_function_two(co_stream s_in, co_stream s_out);

void config_function(void * arg)
{
    co_process test_function_two_proc, function_two_proc, stub_function_two_proc;
    ...
    test_function_two_proc = co_process_create("test_function_two", (co_function)test_function_two,
                                       2,                  
                                       stream_stub_test,
    ...
    stub_function_two_proc = co_process_create("stub_function_two", (co_function)stub_function_two,
                                        2,
										stream_function_stub,
										stream_stub_test);
    ...
    co_process_config(stub_function_two_proc, co_loc, "PE0");
