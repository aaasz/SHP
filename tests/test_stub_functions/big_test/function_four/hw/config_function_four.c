...
extern void test_function_four(co_stream s_in, co_stream s_out);
extern void function_four(co_stream s_in, co_stream s_out);
extern void stub_function_four(co_stream s_in, co_stream s_out);

void config_function(void * arg)
{
    co_process test_function_four_proc, function_four_proc, stub_function_four_proc;
    ...
    test_function_four_proc = co_process_create("test_function_four", (co_function)test_function_four,
                                       2,                  
                                       stream_stub_test,
    ...
    stub_function_four_proc = co_process_create("stub_function_four", (co_function)stub_function_four,
                                        2,
										stream_function_stub,
										stream_stub_test);
    ...
    co_process_config(stub_function_four_proc, co_loc, "PE0");
